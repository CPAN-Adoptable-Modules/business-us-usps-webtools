...
=for HTML
<a href='https://coveralls.io/github/briandfoy/business-us-usps-webtools?branch=master'><img src='https://coveralls.io/repos/briandfoy/business-us-usps-webtools/badge.svg?branch=master&service=github' alt='Coverage Status' /></a>
...
=for HTML <a href="http://www.metacpan.org/module/Business::US::USPS::WebTools"><img src="https://img.shields.io/cpan/v/Business-US-USPS-WebTools.svg" /></A>

=head1 The Business::US::USPS::WebTools module

This is the I<README> for the L<Business::US::USPS::WebTools> Perl module. You're probably 
...
To read about L<Business::US::USPS::WebTools>, look at the embedded documentation 
in the module itself. Inside the distribution, you can format it 
with L<perldoc|http://perldoc.perl.org/perldoc.html>:

	% perldoc lib/Business/US/USPS/WebTools.pm

If you have already installed the module, you can specify the module
name instead of the file location:

	% perldoc Business::US::USPS::WebTools

You can read the documentation and inspect the meta data on one of the 
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Business-US-USPS-WebTools> or 
L<MetaCPAN|http://www.metacpan.org/module/Business::US::USPS::WebTools>:

=over 4

=item *	L<http://search.cpan.org/dist/Business-US-USPS-WebTools>

=item *	L<http://www.metacpan.org/module/Business::US::USPS::WebTools>
...
and install the dependencies:
	...
	% cpan Business::US::USPS::WebTools
