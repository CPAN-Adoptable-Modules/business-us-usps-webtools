...
<ZipCodeLookupResponse><Address ID="0"><Address2>6406 IVY LN</Address2><City>GREENBELT</City><State>MD</State><Zip5>20770</Zip5><Zip4>1441</Zip4></Address></ZipCodeLookupResponse>
XML
	$response =~ s/\s+\z//;
	$expected =~ s/\s+\z//;
...
subtest good_request_3 => sub {
	...
	my $expected = <<"XML";
<?xml version="1.0" encoding="UTF-8"?>
<ZipCodeLookupResponse><Address ID="0"><Address2>4411 ROMLON ST</Address2><City>BELTSVILLE</City><State>MD</State><Zip5>20705</Zip5><Zip4>2425</Zip4><ReturnText>Default address: The address you entered was found but more information is needed (such as an apartment, suite, or box number) to match to a specific address.</ReturnText></Address></ZipCodeLookupResponse>
XML
...
subtest error_response_1 => sub {
	...
	my $expected = <<"XML";
<?xml version="1.0" encoding="UTF-8"?>
<ZipCodeLookupResponse><Address ID="0"><Error><Number>-2147219401</Number><Source>clsAMS</Source><Description>Address Not Found.  </Description><HelpFile/><HelpContext/></Error></Address></ZipCodeLookupResponse>
XML
...
# this one no longer returns an hour

subtest error_response_2 => sub {
	my $url = $verifier->_make_url( {
		FirmName => '',
		Address1 => '',
...
subtest error_response_3 => sub {
	...
	my $expected = <<"XML";
<?xml version="1.0" encoding="UTF-8"?>
<ZipCodeLookupResponse><Address ID="0"><Error><Number>-2147219402</Number><Source>clsAMS</Source><Description>Invalid State Code.  </Description><HelpFile/><HelpContext/></Error></Address></ZipCodeLookupResponse>
XML
